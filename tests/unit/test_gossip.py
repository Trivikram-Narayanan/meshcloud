...
class TestGossipProtocol:
    ...
    def test_gossip_pulse_success(
        self, mock_update_status, mock_post, mock_get_all_files, mock_get_all_peers
    ):
        # Setup mock data
    ...
    def test_process_incoming_gossip(self, mock_register, mock_update_status):
        ...
        payload = {"sender": "http://sender:8000", "files": ["hash1", "hash2"]}
